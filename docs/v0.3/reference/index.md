...
> **项目链接**：[GitHub](https://github.com/Maicarons/mailang) · [源码](https://github.com/Maicarons/mailang/tree/master/crates)
...
- [类型系统](/v0.3/reference/types) - 所有类型的详细说明
- [运算符](/v0.3/reference/operators) - 运算符优先级和行为
- [内置函数](/v0.3/reference/builtins) - 标准库函数参考
- [错误码](/v0.3/reference/errors) - 错误代码和消息
