...
> **Project Links**: [GitHub](https://github.com/Maicarons/mailang) · [Playground](https://maicarons.github.io/mailang/playground)
...
| `mailang deps` | Resolve `mailang.toml` path dependencies |
| `mailang publish` / `install` / `search` / `yank` / `registry` | Filesystem / static-HTTP package registry |
