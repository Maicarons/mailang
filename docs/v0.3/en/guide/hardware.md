...
> **Links**: [GitHub](https://github.com/Maicarons/mailang) · [mailang.h](https://github.com/Maicarons/mailang/blob/master/crates/mailang-ffi/include/mailang.h) · [test_c.c](https://github.com/Maicarons/mailang/blob/master/ffi/tests/test_c.c) · [IoT Deployment](/v0.3/en/guide/iot)
...
The C FFI layer expects `std`. For bare-metal Cortex-M4 prefer `mailang-vm` + `mailang-bytecode` (`no_std` + `alloc`) — see [IoT Deployment](/v0.3/en/guide/iot).
...
- **End-to-end blink**: [ESP32 Blink](/v0.3/en/guide/esp32-blink) (`examples/iot_blink.mai` + IDF-style C host)
- Footprint: [Footprint](/v0.3/en/guide/footprint)
- Header: `crates/mailang-ffi/include/mailang.h`
