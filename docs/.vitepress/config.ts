          ...
          '/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: '包注册表', link: '/guide/registry' },
                { text: 'FFI 接入', link: '/guide/ffi' },
                { text: 'WASM 集成', link: '/guide/wasm' },
                { text: 'IoT 部署', link: '/guide/iot' },
                { text: '真实硬件', link: '/guide/hardware' },
                { text: 'ESP32 点灯', link: '/guide/esp32-blink' },
                { text: '体积仪表盘', link: '/guide/footprint' },
              ],
            },
          ],
          '/reference/': [
          ...
          '/en/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Package Registry', link: '/guide/registry' },
                { text: 'FFI', link: '/en/guide/ffi' },
                { text: 'WASM', link: '/en/guide/wasm' },
                { text: 'IoT Deployment', link: '/en/guide/iot' },
                { text: 'Real Hardware', link: '/en/guide/hardware' },
                { text: 'ESP32 Blink', link: '/en/guide/esp32-blink' },
                { text: 'Footprint', link: '/guide/footprint' },
              ],
            },
          ],
          '/reference/': [
